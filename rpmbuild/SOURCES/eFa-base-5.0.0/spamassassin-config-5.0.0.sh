#!/bin/sh
#-----------------------------------------------------------------------------#
# eFa 5.0.0 initial spamassasin-configuration script
#-----------------------------------------------------------------------------#
...
echo '    geodb_search_path /usr/share/GeoIP' >> /etc/MailScanner/spamassassin.conf
echo 'endif' >> /etc/MailScanner/spamassassin.conf
...
# Enable ASN plugin
#sed -i "/^# loadplugin Mail::SpamAssassin::Plugin::ASN/ c\loadplugin Mail::SpamAssassin::Plugin::ASN" /etc/mail/spamassassin/v320.pre
...
chmod g+w /usr/share/httpd/.spamassassin
chgrp mtagroup /var/lib/spamassassin
chmod g+w /var/lib/spamassassin
